...
#define THP_FUNCTION_DEFAULT_METHODS \
  ...
  {(char*)"_register_pre_hook_dict", THPCppFunction_register_pre_hook_dict, METH_O, nullptr}, \
  {(char*)"register_pre_hook", THPCppFunction_register_pre_hook, METH_O, nullptr}
