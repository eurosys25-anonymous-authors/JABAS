...
struct to_ir {
 ...
 private:
  ...
  void emitAugAssignmentToSubscript(const AugAssign& stmt) {
    // std::cout << "[DEBUG][torch/csrc/jit/frontend/ir_emitter.cpp] emitAugAssignmentToSubscript() -> Graph::createList() is called!" << std::endl;
  ...
  void emitSubscriptAssign(
    ...
    // std::cout << "[DEBUG][torch/csrc/jit/frontend/ir_emitter.cpp] emitSubscriptAssign() -> Graph::createList() is called!" << std::endl;
  ...
  std::shared_ptr<SugaredValue> emitApplySpecialForm(
    ...
    switch (form) {
      ...
      case prim::list: {
        // std::cout << "[DEBUG][torch/csrc/jit/frontend/ir_emitter.cpp] prim::list -> Graph::createList() is called!" << std::endl;
  ...
  Value* emitSimpleExpr(
    ...
    switch (tree->kind()) {
      ...
      case TK_LIST_LITERAL: {
        // std::cout << "[DEBUG][torch/csrc/jit/frontend/ir_emitter.cpp] case TK_LIST_LITERAL -> Graph::createList() is called!" << std::endl;
  ...
  Value* emitIndex(
    ...
    // std::cout << "[DEBUG][torch/csrc/jit/frontend/ir_emitter.cpp] Value* emitIndex() -> Graph::createList() is called!" << std::endl;
